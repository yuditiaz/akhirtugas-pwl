          ...
          <div class="row">
            ...
            <div class="col-md-12">
              <!-- <div class="form-group">
                ...
                <div class="col-sm-10"> -->
                  <input type="hidden" name="id_pembeli" class="form-control" value="<?php echo $nomot;?>" required>
                <!-- </div>
              </div> -->
              <div class="form-group">
                <label class="col-sm-2">Nama Pembeli</label>
                <div class="col-sm-10">
                  <input type="text" name="nama_pembeli" class="form-control" value="<?php echo $val['nama_pembeli'];?>" required>
                </div>
              </div>
              <div class="form-group">
                <label class="col-sm-2">Alamat Pembeli</label>
                <div class="col-sm-10">
                 <textarea id="editor" name="alamat_pembeli" cols="45" rows="5" class="form-control"><?php echo htmlentities($val['alamat_pembeli']);?></textarea>
                </div>
              </div>
             <div class="form-group">
              ...
              <div class="form-group">
                ...
                <div class="col-sm-10">
                  <input type="text" name="email" class="form-control" value="<?php echo $val['email'];?>" required>
                </div>
              </div>
              <div class="form-group">
                <label class="col-sm-2">Umur</label>
                <div class="col-sm-10">
                  <input type="text" name="umur" class="form-control" value="<?php echo $val['umur'];?>" required>
                </div>
              </div>
              <div class="form-group">
